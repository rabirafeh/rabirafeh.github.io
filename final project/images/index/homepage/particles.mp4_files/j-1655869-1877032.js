...
(function(){
    ...
    (function() {
    var p = "1655869", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_1655869||'',
    GUID:window.ftGUID_1655869||'99999999999',
    confID:window.ftConfID_1655869||'0',
    ftReturn: window.ftReturn_1655869||'',
    keyword:window.ftKeyword_1655869||'',
    ftId:window.ftId_1655869||'',
    imp:window.ftImp1655869,
    ftImpId:window.ftImp1655869 && window.ftImp1655869.impID || '',
    campaignID:'58119',
    cID:'75749',
    pID:'1655869',
    creativeID:'1877032',
    exttrack:["https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.GDN.CRDCUT&cvo_creative=CDA_wklyOrange_170525_300x250.zip&cvo_pid=SLNGD_USA_CRDCUT_DT_DIS_GDN_PPR_AFFINCORDC_ROKU23x_XXXXXX_300x250"],
    extscript:["https://z.moatads.com/keplerslingtvflashtalking517548650154/moatad.js#moatClientLevel1=58119&moatClientLevel2=5056&moatClientLevel3=1655869&moatClientLevel4=1877032[noCachebuster]"],
    clickTags: ["http://servedby.flashtalking.com/click/8/58119;1655869;1877032;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.sling.com?cvosrc=Display.GDN.CRDCUT&cvo_creative=CDA_wklyOrange_170525_300x250.zip&cvo_pid=SLNGD_USA_CRDCUT_DT_DIS_GDN_PPR_AFFINCORDC_ROKU23x_XXXXXX_300x250&utm_source=rtbprospecting&utm_medium=display&utm_campaign=ROKU23x"],
    placementDescription:'SLNGDUSACRDCUTDTDISGDNPPRAFFINCORDCROKU23xXXXXXX300x250',
    width:300,
    height:250,
    ...
    divID:'ftdiv1655869',
    phID:'ftpos1655869',
    frameID:'ftframe1655869',
    expID:'ftexpframe1655869',
    altImgID:'ftalt1655869',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/58119;1655869;1877032;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.sling.com?cvosrc=Display.GDN.CRDCUT&cvo_creative=CDA_wklyOrange_170525_300x250.zip&cvo_pid=SLNGD_USA_CRDCUT_DT_DIS_GDN_PPR_AFFINCORDC_ROKU23x_XXXXXX_300x250&utm_source=rtbprospecting&utm_medium=display&utm_campaign=ROKU23x',
    altImg:'http://servedby.flashtalking.com/imp/8/58119;1655869;204;gif;GoogleDisplayNetwork;SLNGDUSACRDCUTDTDISGDNPPRAFFINCORDCROKU23xXXXXXX300x250/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/58119;1655869;271;pixel;GoogleDisplayNetwork;SLNGDUSACRDCUTDTDISGDNPPRAFFINCORDCROKU23xXXXXXX300x250/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/8/58119;1655869;207;guid;GoogleDisplayNetwork;SLNGDUSACRDCUTDTDISGDNPPRAFFINCORDCROKU23xXXXXXX300x250/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/165/1655869/1877032/js/j-1655869-1877032.js',
    file:'http://cdn.flashtalking.com/75749/1877032/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?89850252-1655869;1877032;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_1655869||'',
    segmentList:window.ftSegmentList_1655869||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp1655869 && window.ftImp1655869.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m1655869')&&/^https:/.test(document.getElementById('ftscript_m1655869').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m1655869'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_1655869'],
        ['ftcfid', 'ftConfID_1655869'],
        ['fttime', 'ftTimestamp_1655869'],
        ['ftsection', 'ftSection_1655869'],
        ['ftcustom', 'ftCustom_1655869'],
        ['ft_id', 'ftId_1655869'],
        ['ftimpid','ftImp1655869', 'impID']
    ]
};
